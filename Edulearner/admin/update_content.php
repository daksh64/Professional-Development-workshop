...
<section class="video-form">
   ...
   <h1 class="heading">Upload Course</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Update Learning Path</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--Select Path</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>No Learning Path created</option>';
         }
         ?>
      </select>
