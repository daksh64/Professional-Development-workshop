...
<section class="playlist-form">
   ...
   <h1 class="heading">Update Path</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Path title <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="enter Path title" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>Path description <span>*</span></p>
      ...
      <p>Path thumbnail <span>*</span></p>
      <div class="thumb">
         <span><?= $total_videos; ?></span>
         <img src="../uploaded_files/<?= $fetch_playlist['thumb']; ?>" alt="">
      </div>
      <input type="file" name="image" accept="image/*" class="box">
      <input type="submit" value="update Path" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this Path?');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">view Path</a>
      </div>
   </form>
   <?php
      } 
   }else{
      echo '<p class="empty">no Path added yet!</p>';
   }
   ?>
