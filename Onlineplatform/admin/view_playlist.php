...
<section class="playlist-details">
   ...
   <h1 class="heading">Path details</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update Path</a>
            <input type="submit" value="delete Path" class="delete-btn" onclick="return confirm('delete this Path?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">no Path found!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <h1 class="heading">Path videos</h1>
