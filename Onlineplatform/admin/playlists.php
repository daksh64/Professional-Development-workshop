...
<section class="playlists">
   ...
   <h1 class="heading">Added Path</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Create New Learning Path</h3>
         <a href="add_playlist.php" class="btn">Add Path</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">view Path</a>
      </div>
      <?php
         } 
      }else{
